...
import { getFoodItems, saveNewItem } from "../utils/firebaseFunctions";
...
const CreateContainer = () => {
  ...
  const handleImageUpload = (e) => {
    ...
    if (fileData.size > maxSizeInBytes) {
      setFields(true);
      setMsg("File size exceeds 2.5 MB. Please upload a smaller image.");
                ...
                <>
                  <div className="relative w-full h-full">
                    <img
                      src={imageAsset}
                      alt="uploaded"
                      className="w-full h-[200px] md:h-[310px] mt-3 md:mt-10 object-contain" // Set a fixed height and use object-contain
                    />
                    <button
                      type="button"
